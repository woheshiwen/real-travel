...
export type DriveLeg = {
  ...
  dayId: string
  /** i18n key for the leg title */
  labelKey: string
  /** i18n key for short helper text */
  noteKey: string
  from: AmapPoint
  to: AmapPoint
  via?: AmapPoint
...
export const xianDriveLegs: DriveLeg[] = [
  {
    ...
    dayId: 'day1',
    labelKey: 'amap.leg.day1.airport',
    noteKey: 'amap.leg.day1.airport.note',
  ...
  },
  {
    ...
    dayId: 'day2',
    labelKey: 'amap.leg.day2.morning',
    noteKey: 'amap.leg.day2.morning.note',
  ...
  },
  {
    ...
    dayId: 'day2',
    labelKey: 'amap.leg.day2.afternoon',
    noteKey: 'amap.leg.day2.afternoon.note',
